<?php
	...
	if($fid != NULL) {
		...
		$query = "SELECT u.username, o.order_id, o.user_id, o.paid, o.ready, o.complete from user_order o, user u where o.farmstand_id = $fid and o.user_id = u.user_id and o.ready = 0;";
